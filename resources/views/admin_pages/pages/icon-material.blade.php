            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Carte des etudiants</h3>
                        <ol class="breadcrumb">
                ...
                <div class="col row-cols-1 row-cols-md-1 pr-5 pl-5 mb-5">
                   ...
                   <div class="col mb-4">
                            <div class="card-body bg-white" style="border: 3px solid black; border-radius: 15px; box-shadow: 6px 6px 3px red">
                                ...
                                <div class="card-body text-center">
                                    <p class="card-text justify-text text-dark">{{$etudiant->etudiant_cycle->nom}}</p>
                                </div>
                                <div class="card-body text-center">
                                    <p class="card-text justify-text text-dark">{{$etudiant->etudiant_cycle->annzz}}</p>
                                </div><div class="card-body text-center">
                                    <p class="card-text justify-text text-dark">{{$etudiant->etudiant_cycle->filiere}}</p>
                                </div>
